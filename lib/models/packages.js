...
PackageGnome.Packages.helpers({
  getStations: function(){
    return PackageGnome.Stations.find({consignmentKey:this._id},{sort:{created:1}}).fetch();
  },

  getCurrentStation: function(){
    return PackageGnome.Stations.findOne({consignmentKey:this._id},{sort:{created:-1}});
  },
